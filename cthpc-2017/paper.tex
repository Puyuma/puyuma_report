...
\begin{table}
	...
	\begin{tabular}{ll}
		Hardware                & Budgets  \\
		Raspberry Pi3 Model B   & 39.79 USD \\
...
Figure \ref{fig:extrinsic} show the result of Homography transformation, we exploit the transformation for the lane detection algorithm, the result is usually called the bird view image or inverse perspective mapping.
